      ...
      <section class="tab-components">
        <div class="container-fluid">
          ...
          <div class="form-elements-wrapper">
              ...
              <div class="col-md-6">
                <div class="select-style-1">
                  <div class="select-position">
                    <select class="form-control" id="selectFunction" name="selectFunction">
            ...
            <!-- fun1 -->
            <div id="function1" style="display: none;">
              <div class="row">
                <div class="col-lg-12">
                  <!-- input style start -->
                  <div class="card-style mb-30">
                    <form action="" method="post">
                      ...
                      <div class="row">
                          ...
                          <div class="select-style-1">
                            ...
                            <div class="select-position">
                              <select class="form-control" id="discountType" name="discountType">
                                <option value="">請選擇折扣方式</option>
                                <option value="">按比例計算</option>
                                <option value="">平分</option>
                                <option value="">統一折扣(%off)</option>
                              </select>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-style-1">
                            <label for="discount">折扣(無請輸入0):</label>
                ...
                <!-- fun2 -->
                <div id="function2" style="display: none;">
                  <div class="row">
                    <div class="col-lg-12">
                      <!-- input style start -->
                      <div class="card-style mb-30">
