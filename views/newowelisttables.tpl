    ...
    <aside class="sidebar-nav-wrapper">
      ...
      <div class="promo-box">
        <div class="promo-icon">
          <img class="mx-auto" src="./static/images/logo/logo-icon-big.svg" alt="Logo">
        </div>
                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="static/images/lead/lead-6.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            John Doe
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="static/images/lead/lead-1.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Jonathon
                ...
                <div class="header-message-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="static/images/lead/lead-5.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>Jacob Jones</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="static/images/lead/lead-3.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>John Doe</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="static/images/lead/lead-2.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>Anee Lee</h6>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="min-width">
                            <div class="lead">
                              <div class="lead-image">
                                <img src="static/images/lead/lead-4.png" alt="" />
                              </div>
                              <div class="lead-text">
                                <p>Jonathon</p>
                              </div>
